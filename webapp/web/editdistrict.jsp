<%-- 
    Document   : editdistrict
    Created on : 13 Sep, 2022, 2:13:36 PM
    ...
    <center>
        ...
        <%
            ...
            if (!ispostback) {
                ...
                PreparedStatement ps = DbConnect.connect().prepareStatement("update    District_State set Districtname=? where District=? and Stateno=?");
